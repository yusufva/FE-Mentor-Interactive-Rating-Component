const CardThankyou = ({ id }) => {
    return (
        <div className="w-full max-w-sm p-8 bg-gradient-to-b from-[#202731] to-[#171e28] rounded-2xl m-7 justify-between">
            <div className="justify-between items-center w-full mb-2">
                <svg
                    width="162"
                    height="108"
                ...
                <div className="justify-between items-center rounded-full w-full max-w-48 bg-gray-700 mb-4 text-orange-500 mx-auto">
            ...
            <div className="justify-between items-center mb-3">
                <h1 className="text-white font-overpass text-xl font-bold mb-2 mt-8 mx-auto w-full max-w-28">
                    Thank you!
                </h1>
